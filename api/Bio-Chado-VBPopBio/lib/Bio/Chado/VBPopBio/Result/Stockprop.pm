package Bio::Chado::VBPopBio::Result::Stockprop;

use feature 'switch';
use base 'Bio::Chado::Schema::Result::Stock::Stockprop';
__PACKAGE__->load_components(qw/+Bio::Chado::VBPopBio::Util::Subclass/);
__PACKAGE__->subclass({ stock => 'Bio::Chado::VBPopBio::Result::Stock',
			type => 'Bio::Chado::VBPopBio::Result::Cvterm',
		      });

=head1 NAME

Bio::Chado::VBPopBio::Result::Stockprop
...
1; # End of Bio::Chado::VBPopBio::Result::Stockprop
